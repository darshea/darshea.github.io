  ...
  return (
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", color: '#1a1a1a', lineHeight: '1.7' }}>
      ...
      <div style={{ marginBottom: 16 }}>
        <a href="/ads/weekly/issue-14/" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', borderTop: '1px solid #f0f0f0', padding: '14px 0', textDecoration: 'none', color: '#1a1a1a' }}>
          <div>
            <span style={{ fontSize: 14 }}>ISSUE #14 — AI Kills the Middleman: Local Search, iBuying, EdTech &amp; Ad Agencies vs. AI Infrastructure Picks</span>
          ...
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: '#aaa', flexShrink: 0, marginLeft: 16 }}>July 8, 2026</span>
        </a>
        <a href="/ads/weekly/issue-13/" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', borderTop: '1px solid #f0f0f0', padding: '14px 0', textDecoration: 'none', color: '#1a1a1a' }}>
          <span style={{ fontSize: 14 }}>ISSUE #13 — AI Builds and Displaces: Infrastructure Winners vs. Legacy Platform Losers</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: '#aaa', flexShrink: 0, marginLeft: 16 }}>July 1, 2026</span>
        </a>
        ...
        <a href="/ads/weekly/issue-7/" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', borderTop: '1px solid #f0f0f0', padding: '14px 0', textDecoration: 'none', color: '#1a1a1a' }}>
          <span style={{ fontSize: 14 }}>ISSUE #7 — The AI Efficiency Dividend</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: '#aaa', flexShrink: 0, marginLeft: 16 }}>April 29, 2026</span>
        </a>
        <a href="/ads/weekly/issue-6/" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', borderTop: '1px solid #f0f0f0', padding: '14px 0', textDecoration: 'none', color: '#1a1a1a' }}>
          <span style={{ fontSize: 14 }}>ISSUE #6 — The AI Economy&apos;s Infrastructure Layer</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: '#aaa', flexShrink: 0, marginLeft: 16 }}>April 22, 2026</span>
        </a>
        <a href="/ads/weekly/issue-5/" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', borderTop: '1px solid #f0f0f0', padding: '14px 0', textDecoration: 'none', color: '#1a1a1a' }}>
          <span style={{ fontSize: 14 }}>ISSUE #5 — The AI Economy&apos;s Winners and Losers</span>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: '#aaa', flexShrink: 0, marginLeft: 16 }}>April 15, 2026</span>
        </a>
